...
**Why this changed.** The main reason we decreased the free plan is that running RoleLogic has become more expensive. Since ELSE branches arrived, a rule can act on *every* member rather than only the ones who match — so the same 5 free rules now do far more work than they did before. With around 99% of our servers on the free plan, that extra work adds up quickly across the whole bot. Moving the free allowance to 2 helps cover hosting and keeps RoleLogic fast and reliable for everyone. We completely understand the frustration, and we truly appreciate your understanding and support.
